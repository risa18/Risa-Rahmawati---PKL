...
<body>
    ...
    <hr>
    <!-- <h3>Laporan Data SK Izin Usaha</h3> -->
    <h5 style="text-align: center; margin-bottom: 20px;">Laporan Rekapitulasi Data Izin Usaha</h5>
    <center>
        <table style="border: 1px solid black; border-collapse: collapse; width: 100%;" class="text-center">
            <thead>
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    ...
                    <th style="border: 1px solid black; border-collapse: collapse;">Nama Usaha</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                        <tr style="border: 1px solid black; border-collapse: collapse;">
                            ...
                            <td style="border: 1px solid black; border-collapse: collapse;"><?= $row['nama_usaha'] ?></td>
                        </tr>
