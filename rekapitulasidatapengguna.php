...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            <!-- begin page-header -->
            <h1 class="page-header">Rekapitulasi Data Pengguna</h1>
            <!-- end page-header -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="table-basic-7">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Rekapitulasi Data Pengguna</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="with-btn" nowrap>
                                                        <?php if ($_SESSION['level'] == 'Admin') : ?>
                                                            <a href="inputdatapengguna.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary width-60 m-r-2">Edit</a>
                                                            <a href="deletedata.php?id=<?= $row['id'] ?>&tabel=data_pengguna" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" class="btn btn-sm btn-danger width-60">Delete</a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
