...
<body>
    ...
    <hr>
    <!-- <h3>Laporan Data SK Pindah</h3> -->
    <h5 style="text-align: center; margin-bottom: 20px;">Laporan Rekapitulasi Data Pindah</h5>
    <center>
        <table style="border: 1px solid black; border-collapse: collapse; width: 100%;" class="text-center">
            <thead>
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    ...
                    <th style="border: 1px solid black; border-collapse: collapse;">Pindah Dari</th>
                    <th style="border: 1px solid black; border-collapse: collapse;">Alasan Pindah</th>
                    <th style="border: 1px solid black; border-collapse: collapse;">Alamat Baru</th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                ?>
                        <tr style="border: 1px solid black; border-collapse: collapse;">
                            ...
                            <td style="border: 1px solid black; border-collapse: collapse;"><?= $row['pindah_dari'] ?></td>
                            <td style="border: 1px solid black; border-collapse: collapse;"><?= $row['alasan_pindah'] ?></td>
                            <td style="border: 1px solid black; border-collapse: collapse;"><?= $row['alamat_baru'] ?></td>
                        </tr>
