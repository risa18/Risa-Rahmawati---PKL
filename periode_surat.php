...
//     header("Location: cetakrekapdatasurat.php?tanggal1=$tanggal1&tanggal2=$tanggal2");
//     exit();
// }
...
<head>
    <meta charset="utf-8" />
    <title>Web Apps | Rekapitulasi Data Layanan Surat</title>
...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            <!-- begin page-header -->
            <h1 class="page-header">Masukan Periode Tanggal</h1>
            <!-- end page-header -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Masukan Periode Tanggal</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <form action="cetakrekapdatasurat.php" method="post">
                                <input type="hidden" name="id" value="<?= $id ?>">
                                <input type="hidden" name="jenis_post" value="<?= $jnspost ?>">
                                <div class="form-group row m-b-15">
                                    <label class="col-form-label col-md-3">Dari Tanggal</label>
                                    <div class="col-md-9">
                                        <input type="date" class="form-control m-b-5" name="tanggal1" />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-form-label col-md-3">Sampai Tanggal</label>
                                    <div class="col-md-9">
                                        <input type="date" class="form-control m-b-5" name="tanggal2" />
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-sm btn-primary m-r-5">Print</button>
