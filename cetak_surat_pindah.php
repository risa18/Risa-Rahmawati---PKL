...
<head>
    <meta charset="utf-8" />
    <title>Web Apps | Surat Pindah</title>
...
<body>
    ...
    $no = 1;
    $id = $_GET['id'];
    $result = $koneksi->query("SELECT * FROM data_pindah JOIN data_penduduk ON data_pindah.id_penduduk = data_penduduk.id WHERE data_pindah.id = $id");
    $no = 1;
    if ($result->num_rows > 0) :
        while ($row = $result->fetch_assoc()) {
    ?>

            <h4 style="text-align: center; margin-bottom: 10px;"><u>Surat Pindah</u></h4>
            ...
            <justify>
                <p> &emsp;
                    <b><i>Telah memustuskan untuk pindah</i></b> dengan keterangan yang diketahui sebagai berikut :
                </p>
                <p>&emsp; &emsp; &emsp; Pindah dari &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;: <?= $row['pindah_dari'] ?></p>
                <p>&emsp; &emsp; &emsp; Alamat baru &ensp; &emsp; &emsp; &emsp; &emsp; &emsp;: <?= $row['alamat_baru'] ?></p>
                <p>&emsp; &emsp; &emsp; Dengan Alasan &ensp; &emsp; &emsp; &emsp; &emsp;: <?= $row['alasan_pindah'] ?></p>

                <p> &emsp; Demikian <b>SURAT PINDAH</b> ini kami buat atas dasar yang sebenarnya kepada pihak terkait mohon maklum adanya.</p>
                <br />
            </justify>
