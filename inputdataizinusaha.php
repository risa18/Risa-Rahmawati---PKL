...
$no_surat = "SKU-" . rand(10, 99) . rand(10, 99) . "/" . date('m/y');
$nik = "";
$nama = "";
$tanggal_lahir = "";
$jenis_kelamin = "";
...
if ($_GET) {
    if ($_GET['status'] == '0') {
        $id_usaha = $_GET['id'];
        $result = $koneksi->query("SELECT * FROM data_izinusaha WHERE id = $id_usaha");
...
<head>
    <meta charset="utf-8" />
    <title>Web Apps | Data Izin Usaha</title>
...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            <!-- begin page-header -->
            <h1 class="page-header">Tambah Data Izin Usaha</h1>
            <!-- end page-header -->
            <?php
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Form Input Data Izin Usaha</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <form action="prosesusaha.php" method="post">
                                <input type="hidden" name="id_usaha" value="<?= $idusaha ?>">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="nik" class="form-control m-b-5" value="<?= $nik ?>" placeholder="Masukan NIK" readonly />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-form-label col-md-3">Nama</label>
                                    <div class="col-md-9">
                                        <input type="text" name="nama" class="form-control m-b-5" value="<?= $nama ?>" placeholder="Masukan Nama" readonly />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="pekerjaan" value="<?= $pekerjaan ?>" class="form-control m-b-5" placeholder="Masukan Pekerjaan" readonly />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
